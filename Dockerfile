ARG SOURCE_DIGEST=9e666aeefa9801445bc2ff4994c48d314736dae4cf1f551ace03e38ea0373552
FROM nginx:1.31.0-alpine3.23-slim@sha256:${SOURCE_DIGEST}
ARG SOURCE_DIGEST
...
LABEL de.gematik.commit-sha=$COMMIT_HASH \
    ...
    de.gematik.app="DEMIS Notification Portal Pathogen" \
    de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions/git/demis/portal/portal-pathogen.git"
