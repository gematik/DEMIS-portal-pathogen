...
export const CLIPBOARD_VALUE_LABORATORY_ORDER_ID = '1-2-3-4';
export const CLIPBOARD_VALUE_NOTIFICATION_ID_REFERENCE = 'OWN';
...
export const CLIPBOARD_VALUE_ANALYT = '710543001';
