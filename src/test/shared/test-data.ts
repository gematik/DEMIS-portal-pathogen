...
import {
  ...
  CLIPBOARD_KEY_INITIAL_NOTIFICATION_ID,
  CLIPBOARD_KEY_INTERPRETATION,
  CLIPBOARD_KEY_INTERPRETATION_TEXT,
  CLIPBOARD_KEY_MATERIAL,
  CLIPBOARD_KEY_METHOD,
  CLIPBOARD_KEY_NOTIFICATION_CATEGORY,
  CLIPBOARD_KEY_RECEIVED_DATE,
  CLIPBOARD_KEY_REPORTSTATUS,
  ...
  CLIPBOARD_VALUE_INTERPRETATION,
...
export const TEST_PARAMETER_CLIPBOARD_NOTIFICATION_CATEGORY_AND_DIAGNOSTIC = [
  [CLIPBOARD_KEY_NOTIFICATION_CATEGORY, CLIPBOARD_VALUE_NOTIFICATION_CATEGORY],
  [CLIPBOARD_KEY_SUBPATHOGEN, CLIPBOARD_VALUE_SUBPATHOGEN],
  [CLIPBOARD_KEY_REPORTSTATUS, CLIPBOARD_VALUE_REPORTSTATUS],
  [CLIPBOARD_KEY_INTERPRETATION_TEXT, CLIPBOARD_VALUE_INTERPRETATION_TEXT],
  [CLIPBOARD_KEY_INITIAL_NOTIFICATION_ID, CLIPBOARD_VALUE_INITIAL_NOTIFICATION_ID],
  [CLIPBOARD_KEY_INTERPRETATION, CLIPBOARD_VALUE_INTERPRETATION],
  [CLIPBOARD_KEY_COLLECTED_DATE, CLIPBOARD_VALUE_COLLECTED_DATE],
  [CLIPBOARD_KEY_RECEIVED_DATE, CLIPBOARD_VALUE_RECEIVED_DATE],
  [CLIPBOARD_KEY_MATERIAL, CLIPBOARD_VALUE_MATERIAL],
  [CLIPBOARD_KEY_METHOD, CLIPBOARD_VALUE_METHOD],
];
